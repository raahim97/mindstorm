...
from MindStorm.settings import STATIC_URL
...
urlpatterns = [
    ...
    path('admin-add-question-from-file', views.admin_add_question_from_file_view,name='admin-add-question_from_file'),
